...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <footer className="bg-school-blue text-white py-8 sm:py-10 lg:py-12">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 text-center">
          <div className="mb-4 sm:mb-6">
            <h3 className="text-xl sm:text-2xl font-bold mb-2">Jasper Primary School</h3>
            <p className="text-blue-200 text-sm sm:text-base">Nyairongo, Uganda</p>
          </div>
          <p className="text-blue-200 mb-3 sm:mb-4 text-sm sm:text-base">Creating Bright Paths Together</p>
